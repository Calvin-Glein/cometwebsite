...
<!--                    <div class="ui basic segment noverticalpad">-->
        ...
        $loop = new WP_Query(array('post_type' => 'event', 'posts_per_page' => 10, 'paged' => $paged));
        if ($loop->have_posts()) :
        ...
        <div class="row ui vertical segment">
                ...
                <div class="sixteen wide column"> 
                    <h2 class="ui header"><a href="<?php the_permalink(); ?>"> <?php echo the_title(); ?></a>
                        <div class="ui sub header mini"> <?php the_field('datestart'); if( get_field('dateend') ): ?>
                                - <?php the_field('dateend'); ?>
                            <?php endif;?></div>
                    </h2>
                    <p style = "text-align: justify; text-justify: inter-word;"><?php echo get_the_excerpt(); ?></p>
                </div>
            </div>
            <?php endwhile; ?>
